...
import Navbar from "../monetizationAndRewardManagement/Navbar";
import apiService from "../../services/api";
import Swal from 'sweetalert2';
import Sidebar from '../monetizationAndRewardManagement/Sidebar';
...
const UserDashboard = () => {
    ...
    return (
      <div className="mt-3 mb-4">
        <img 
          ...
          alt="Progress media" 
          className="object-contain max-w-full mx-auto rounded-lg max-h-80" 
        />
      </div>
    );
  };
  ...
  if (loading) {
    return (
      <div>
        <Navbar />
        <div className="flex flex-col items-center justify-center min-h-screen pt-20 bg-gradient-to-br from-indigo-50 to-blue-100"> {/* Added pt-20 for navbar spacing */}
    ...
    <div>
      ...
      <div className="flex min-h-screen pt-20 font-sans bg-gradient-to-br from-blue-50/80 to-indigo-50/80">
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          ...
          <div className="relative mb-8 overflow-hidden bg-white shadow-md rounded-xl">
            ...
            <div className="relative flex flex-col px-6 py-8 md:flex-row md:items-center">
              ...
              <div className="flex items-center justify-center mb-4 md:mb-0 md:mr-8">
                <div className="relative">
                  <div className="flex items-center justify-center w-20 h-20 text-2xl font-bold text-white rounded-full bg-gradient-to-br from-indigo-600 to-blue-500">
              ...
              <button
                ...
                className="flex items-center px-5 py-2 mt-4 text-sm font-medium text-white transition duration-300 rounded-lg shadow bg-gradient-to-r from-indigo-600 to-blue-500 hover:shadow-md md:mt-0"
              >
          ...
          <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-3">
            ...
            <div className="overflow-hidden transition-shadow bg-white shadow-sm rounded-xl hover:shadow-md">
              ...
              <div className="p-6">
                ...
                <button
                  className="flex items-center justify-center w-full gap-2 px-4 py-3 font-medium text-indigo-600 transition duration-300 rounded-lg bg-indigo-50 hover:bg-indigo-100"
            ...
            <div className="overflow-hidden transition-shadow bg-white shadow-sm rounded-xl hover:shadow-md">
              ...
              <div className="p-6">
                ...
                <button
                  className="flex items-center justify-center w-full gap-2 px-4 py-3 mt-3 font-medium text-green-600 transition duration-300 rounded-lg bg-green-50 hover:bg-green-100"
            ...
            <div className="overflow-hidden transition-shadow bg-white shadow-sm rounded-xl hover:shadow-md">
              ...
              <div className="p-6">
                ...
                <button
                  className="flex items-center justify-center w-full gap-2 px-4 py-3 mt-3 font-medium text-blue-600 transition duration-300 rounded-lg bg-blue-50 hover:bg-blue-100"
          ...
          <div className="mb-10 overflow-hidden bg-white shadow-sm rounded-xl">
